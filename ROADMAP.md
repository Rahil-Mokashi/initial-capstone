...
2. Regenerate `docs/screenshots/login.png` and `docs/screenshots/main-window.png` to reflect the current responsive dashboard and analytics work — paused mid-task 2026-08-16 to prioritize Phase 20; `scripts/capture_screenshots.py` (off-screen Qt widget rendering via `QWidget.grab()`, not a screen capture) is the chosen approach, not yet finished
