...
class CreditAccount(Base):
    ...
    __table_args__ = (
        CheckConstraint("credit_limit >= 0", name="ck_credit_accounts_limit_non_negative"),
        CheckConstraint("payment_due_days >= 0", name="ck_credit_accounts_due_days_non_negative"),
    )
